...
export const metadata: Metadata = {
  ...
  description: 'Digital Community & Activity Portal prototype for Jeevan Chetna Foundation (Haldwani, Nainital, Uttarakhand) created as part of the Social Internship Project Report.',
};
